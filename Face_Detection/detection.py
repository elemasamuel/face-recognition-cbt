    ...
    def faceDetect(self, Entry1,):
        ...
        while(True):
            ...
            for (x,y,w,h) in faces:
                ...
                cv2.imwrite(BASE_DIR+'/Face_Detection/dataset/User.' + str(reg_number) + '.' + str(count) + ".jpg", gray[y:y+h,x:x+w])
    ...
    def trainFace(self):
        ...
        def getImagesAndLabels(path):
            ...
            for imagePath in imagePaths:
                ...
                reg_number = int(os.path.split(imagePath)[-1].split(".")[1])
                print("reg_number",reg_number)
                faces = detector.detectMultiScale(img_numpy)

                for (x,y,w,h) in faces:
                    faceSamples.append(img_numpy[y:y+h,x:x+w])
                    ids.append(reg_number)
    ...
    def recognizeFace(self):
        ...
        while True:
            ...
            for(x,y,w,h) in faces:
                ...
                reg_number, confidence = recognizer.predict(gray[y:y+h,x:x+w])
